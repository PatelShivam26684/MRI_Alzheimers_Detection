...
patients_with_cdr_2 = df[df['CDR'] == 2]['ID'].tolist()
patients_with_cdr_1 = df[df['CDR'] == 1]['ID'].tolist()

# Prioritize CDR = 2 and add CDR = 1 to make up 50 patients
selected_patients = patients_with_cdr_2 + patients_with_cdr_1
selected_patients = selected_patients[:47]  # Ensure no more than 50 patients
