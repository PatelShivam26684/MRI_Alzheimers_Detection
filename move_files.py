...
# Load the CSV file with patient data
df = pd.read_csv('/Users/shivampatel/Research/MRI/Oasis/Data/oasis_1/oasis_1_edited.csv')

# Filter for patients with a CDR score of 0
rows_no_alzheimers = df[df['CDR'] == 0]
no_alzheimers = rows_no_alzheimers['ID'].tolist()


# Limit to 50 patients
selected_patients = no_alzheimers[:50]

# Define the source and destination directories
source_dir = '/Users/shivampatel/Research/MRI/Oasis/Data/oasis_1'
dest_dir = '/Users/shivampatel/Research/MRI/Oasis/Data/Non_AD'
...
for patient_id in selected_patients:
    ...
    patient_dirs = glob.glob(f"{source_dir}/disc*/{patient_id}/PROCESSED/MPRAGE/T88_111")
